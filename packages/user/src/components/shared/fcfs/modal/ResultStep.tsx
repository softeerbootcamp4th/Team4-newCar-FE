...
export default function ResultStep({ step }: ResultStepProps) {
	...
	return (
		<div className="flex h-full w-full flex-col items-center justify-center p-[20px]">
			...
			<p className="text-heading-7 font-bold mb-9">{title}</p>
			<p className="text-body-1 text-center whitespace-pre-line font-medium mb-4">{subTitle}</p>
