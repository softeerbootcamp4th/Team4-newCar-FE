...
const dialogVariants = cva(
	'rounded-6 border-2 border-khaki-500 backdrop-blur-xl data-[state=open]:animate-in data-[state=closed]:animate-out w-full h-full data-[state=closed]:fade-out-0 aspect-[16/9] data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] fixed left-[50%] top-[50%] z-50 grid min-h-[200px] max-w-[960px] max-h-[540px] translate-x-[-50%] translate-y-[-50%] shadow-lg duration-200',
	{
		variants: {
			variants: {
